package com.defsat.phystrix.admin.security;
...
public class WwwAuthFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (requestUri.contains(ConfigConstant.SWITCH_NON_FILTER_URI)
				|| requestUri.contains(ConfigConstant.CONFIG_NON_FILTER_URI)) {
